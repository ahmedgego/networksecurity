...
from networksecurity.utils.main_utils.ustils import save_numpy_array_data,save_object
...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationArtifact,
        ...
        try:
            ...
            self.data_transformation_congi:DataTransformationConfig = data_transformation_config
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        logging.info("Entered initiate_data_transformation merthod of DataTransfromation class")
        try:
            ...
            data_transformation_artifact = DataTransformationArtifact(
                transformed_object_file_path = self.data_transformation_congi.transformed_object_file_path,
                transformed_train_file_path  = self.data_transformation_congi.transformed_train_file_path,
                transformed_test_file_path   = self.data_transformation_congi.transformed_test_file_path
            )
